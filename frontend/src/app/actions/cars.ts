...
export async function getCars(params: {
    ...
    try {
        const where: Prisma.carWhereInput = { isDeleted: false };
        ...
        if (params.minPrice) where.price = { ...where.price as object, gte: parseFloat(params.minPrice) };
        if (params.maxPrice) where.price = { ...where.price as object, lte: parseFloat(params.maxPrice) };
